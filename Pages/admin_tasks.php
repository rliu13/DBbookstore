	...
	<body class="d-flex flex-column min-vh-100">
		...
		<div class="container-fluid">
			<div class="login-container text-center bg-white shadow">
				...
				<br/>
				<div class="d-grid gap-2 col-8 mx-auto">
					<a class="btn btn-md btn-primary btn-block" href="screen2.php">Place Orders</a>
				</div>
				<br/>
				<div class="d-grid gap-2 col-8 mx-auto">
				...
				<br/>
				<!-- <div class="d-grid gap-2 col-8 mx-auto">
					<a class="btn btn-md btn-primary btn-block" href="update_adminprofile.php">Update Admin Profile</a>
				</div> -->
				<br/>
				<div class="d-grid gap-2 col-8 mx-auto">
