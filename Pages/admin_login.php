			...
			<div class="login-container bg-white shadow">
				<form action="process5.php" method="POST">
					...
					<div class="form-floating">
						<input required type="text" name="adminName" class="form-control" id="floatingInput">
						<label for="floatingInput">Adminname</label>
					</div>
					<div class="form-floating">
						<input type="password" name="adminPin" class="form-control" id="floatingPassword">
				...
				<div class="d-grid gap-2 col-6 mx-auto">
					<a class="btn btn-md btn-warning btn-block" href="index.php">Cancel</a>
				</div>
			</div>
		</div>
